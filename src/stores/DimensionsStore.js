...
const DimensionsStore = {
  ...
  getTimelineTickInnerX: function(angle) { return this.getRadius() + this.getRadius() * Math.sin(angle); },

  getTimelineTickInnerY: function(angle) { return this.getRadius() - this.getRadius() * Math.cos(angle); },
  ...
  getTimelineDestinationX: function(angle, distance) { return this.getRadius() + this.getDiplomacyDistance(distance) * Math.sin(angle); },

  getTimelineDestinationY: function(angle, distance) { return this.getRadius() - this.getDiplomacyDistance(distance) * Math.cos(angle); },
  ...
  getGraphInnerRadius: function() { return this.getRadius(); },
  ...
  getDiplomacyArc: function(distance, startAngle, endAngle) {
    let radius = this.getDiplomacyDistance(distance);
    return d3.svg.arc()
      .innerRadius(radius - this.getPointRadius())
      .outerRadius(radius + this.getPointRadius() - this.getPointRadius())
      .startAngle(startAngle)
      .endAngle(endAngle)
      .cornerRadius(this.getPointRadius())();
  },

  getDiplomacyDistance(distance) {
